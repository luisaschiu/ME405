...
if __name__ == '__main__':
    ...
    encoder_drv2 = motor_Agena_Chiu.EncoderDriver(pyb.Pin.cpu.C6, pyb.Pin.cpu.C7, 4) #Pg. 53 of data sheet says timer 3?
...
# NOTE: From testing section - Make sure to check “edge cases” such as the maximum and minimum 
# possible duty cycles for proper operation. 100% or 0 %?